        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Architecting and building robust systems using modern development tools, low-code platforms, and seamless API integrations.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Bubble</div>
                <div className="what-tags">Xano</div>
                ...
                <div className="what-tags">No-Code</div>
                <div className="what-tags">Low-Code</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Accelerating the development lifecycle with cutting-edge AI assistants and organizing team workflows for maximum efficiency.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">AI Integrations</div>
                <div className="what-tags">VibeCoding</div>
